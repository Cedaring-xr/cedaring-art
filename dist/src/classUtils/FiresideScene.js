...
class FiresideScene extends Component {
    componentDidMount() {
        ...
        // model loading
        this.loader.load(
            '/models/low_poly_forest_campfire_updated.glb',
            (model) => {
                console.log(model)
        ...
        const coloradoTexture = textureLoader.load(
            '/extras/images/coTexture.png'
        )
        const txtLoader = new FontLoader()
        txtLoader.load(
            '/extras/fonts/helvetiker_regular.typeface.json',
            (font) => {
                const geometryFont = new TextGeometry(
                ...
                const geometryFont2 = new TextGeometry(
                ...
                const geometryFont3 = new TextGeometry(
