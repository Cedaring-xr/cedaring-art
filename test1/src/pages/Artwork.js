...
export default function Artwork()  {
    ...
    return (
        <>
            ...
            <div className={styles.text}>
                <p className={styles.text__content}>I have spent over 250 hours this past year learning more about artwork and the VR art applications. Most of the artwork on show here is made in Openbrush. I have also tried out gravity sketch, and quill. </p>
            </div>
