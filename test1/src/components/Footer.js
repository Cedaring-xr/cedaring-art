    ...
    return (
        <footer className={styles.footer}>
            ...
            <div className={styles.footer__social__icon}>
                <a href="https://twitter.com/CedaringXR" target="_blank" rel="noreferrer" id="twitter">
                    <img
                        src={twitterIcon}
            ...
            <div className={styles.footer__social__icon}>
                <a href="https://www.instagram.com/cedaring_xr/" target="_blank" rel="noreferrer" id="instagram">
                    <img
                        src={instaIcon}
                        className={styles.footer__img}
                    />
            ...
            <div className={styles.footer__social__icon}>
                <a href="https://github.com/Cedaring-xr" target="_blank" rel="noreferrer" id="github">
                    <img
                        src={githubIcon}
                        className={styles.footer__img}
                    />
