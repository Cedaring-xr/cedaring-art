  ...
  return (
    <>
        <div className='video-description-box'>
            <h2 className='video-description'>Some VR scenes are currently harder to import, so here is a video instead. I will work on getting the 3D model added in the future.</h2>
        </div>
